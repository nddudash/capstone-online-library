...
from custom_user.views import login_view, logout_view, sign_up_view, user_profile_view, AuthorDeleteView
...
urlpatterns = [
    ...
    path('delete_user/', AuthorDeleteView.as_view, name='delete_user')
]
